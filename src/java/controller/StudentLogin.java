...
public class StudentLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(  Integer.parseInt(request.getParameter("Id"))+Integer.parseInt(request.getParameter("Route"))+ Long.parseLong(request.getParameter("Phone")));
            ...
            obj.setRoute_Id(route);

            StudentDAO usd= new StudentDAO();
